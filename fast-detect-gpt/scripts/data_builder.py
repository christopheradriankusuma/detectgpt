...
class DataBuilder:
    ...
    def _openai_sample(self, prefix):
        ...
        if self.args.openai_model == 'davinci-002':
            ...
            response = self.client.chat.completions.create(prompt=f"prefix", **kwargs)
            return prefix + response.choices[0].text
...
if __name__ == '__main__':
    ...
    parser.add_argument('--openai_model', type=str, default=None)  # davinci-002, gpt-3.5-turbo, gpt-4
